...
<div class="content-wrapper">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Setup your Resume's</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-default">Add About Attributes</button>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{ route('admin.resume.create') }}" method="post">
                @csrf
  ...
  <script>
    ...
    function editAttr(attrId){
      ...
      var updateUrl = "{{ route('admin.resume.update', ':attrId') }}";
      ...
      var getUrl = "{{ route('admin.resume.show', ':attrId') }}";
    ...
    function actionDelete(){
      ...
      var routeDelete = "{{ route('admin.resume.delete', ':attrId') }}";
