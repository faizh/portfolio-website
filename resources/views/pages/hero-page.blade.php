    ...
    <div class="container">
        <div class="flex flex-wrap">
            <div class="w-full self-center px-4 lg:w-1/2">
                <h1 class="text-dark font-semibold text-base mb-5 lg:text-lg dark:text-white">{{ $hero_attr['welcome_text'] }}</h1>
                <div class="flex flex-wrap">
                    <div class="static-txt text-2xl block ml-1 md:hidden dark:text-white">{{ $hero_attr['greeting_text']}}</div>
                    <div class="wrapper inline-flex items-center w-full">
                        <div class="block text-2xl hidden md:block md:mr-3 dark:text-white">{{ $hero_attr['greeting_text']}}</div>
                        <ul class="dynamic-txts">
                            @foreach ($hero_attr['dynamic_texts'] as $text)
            ...
            <div class="w-full self-end px-4 lg:w-1/2">
                <div class="mt-10 relative lg:mt-0 lg:right-0">
                    <img src="{{ asset($hero_attr['photo_src']) }}" alt="Faiz Hermawan" class="max-w-full mx-auto">
