...
<div class="content-wrapper">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Setup your About's</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
  ...
  <script>
    ...
    function editAttr(attrId){
      ...
      var updateUrl = "{{ route('admin.about.update', ':attrId') }}";
      ...
      var getUrl = "{{ route('admin.about.show', ':attrId') }}";
    ...
    function actionDelete(){
      ...
      var routeDelete = "{{ route('admin.about.delete', ':attrId') }}";
