...
<div class="content-wrapper">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Setup your Portfolio's</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
  ...
  <script>
    ...
    function editAttr(attrId){
      ...
      var updateUrl = "{{ route('admin.portfolio.update', ':attrId') }}";
      ...
      var getUrl = "{{ route('admin.portfolio.show', ':attrId') }}";
    ...
    function actionDelete(){
      ...
      var routeDelete = "{{ route('admin.portfolio.delete', ':attrId') }}";
